      ...
      {loading ? (
        ...
        <>
          ...
          <Row justify="center" gutter={16}>
            <Col lg={16} sm={24}>
              {bookings?.filter((o) => o?.userId == user?.id).map((booking) => {
                return (
                  <Row gutter={16} className="bs1 mt-3 text-left" key={booking?.id}>
                    <Col lg={6} sm={24}>
                      <p>
                    ...
                    <Col lg={12} sm={24}>
                      ...
                      <p>
                        From: <b>{booking?.BookedTimeSlot.from}</b>
                      </p>
                      <p>
                        To: <b>{booking?.BookedTimeSlot.to}</b>
                      </p>
                      <p>
                        Date of booking:
                        <b>
